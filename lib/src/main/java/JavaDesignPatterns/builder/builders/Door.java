...
/**
 * A Door object built of various components. Note: The Door class exists alongside the builders so
 * that its setters may be package protected. This makes it so builders may modify the door during
 * the building process, but the values are immutable after the Door is built.
 */
public class Door {
