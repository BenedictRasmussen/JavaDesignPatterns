...
/**
 * A Panel is the main component of the door. It is made of a material that is painted with a primer and color before
 * being optionally topped with a finish.
 */
public class Panel {
